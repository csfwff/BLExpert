...
abstract class AppLocalizations {
  ...
  /// No description provided for @finalFrameLabel.
  ///
  /// In en, this message translates to:
  /// **'Final frame {length} bytes:'**
  ...
  /// No description provided for @closeLogDetails.
  ///
  /// In en, this message translates to:
  /// **'Close log details'**
  String get closeLogDetails;
  ...
  /// No description provided for @scriptConfirmTransformedSend.
  ///
  /// In en, this message translates to:
  /// **'Confirm script-transformed frame before sending'**
  String get scriptConfirmTransformedSend;

  /// No description provided for @scriptConfirmTransformedSendHint.
  ///
  /// In en, this message translates to:
  /// **'When disabled, the final frame generated by the script is sent directly; high-risk commands and mandatory command confirmations are not affected.'**
