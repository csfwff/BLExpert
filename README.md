...
> 文档基线：2026-08-19。开发状态和优先级以 [开发路线图](docs/开发路线图.md) 为准。
...
- UI 组件以 `shadcn_flutter` 为主：首页工作区菜单、蓝牙设备选择、工具对话框、输入框、选择器、按钮、桌面模式导航、配置导航、设置分段控件、记录筛选和状态徽章均通过 shadcn 组件或本地适配层实现；窄屏底部导航与页面骨架继续保留 Material。
